...
export default function NotFoundPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8f9fc', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', textAlign: 'center' }}>
      ...
      <h1 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#111827', marginBottom: '0.5rem' }}>페이지를 찾을 수 없어요</h1>
      ...
      <div style={{ display: 'flex', gap: '0.75rem' }}>
        <button
          onClick={() => navigate(-1)}
          style={{ padding: '0.625rem 1.25rem', border: '1.5px solid #e5e7eb', borderRadius: '12px', background: 'white', color: '#374151', fontWeight: 600, fontSize: '0.9375rem', cursor: 'pointer' }}
        >
          이전으로
        </button>
        <button
